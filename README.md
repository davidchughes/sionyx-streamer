...
In practice this means you can watch satellites, shooting stars, and see the aurora clearly. It reliably picks up magnitude -5.0 stars and often reaches -7.0 and star colors are occasionally preserved. To smooth out MJPEG compression noise and prevent stars from flickering in and out, frames are averaged over 8 frames by default — still responsive enough to feel like a live view.  You can select 2,4,6,8,16,32,64 and 128 frames at 15fps. The controls are kinda clunky but it works.
